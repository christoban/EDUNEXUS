      ...
      {loading ? (
        ...
        <>
          ...
          <div style={{ background: 'white', borderRadius: 16, border: '1.5px solid #e8e0d4', overflow: 'hidden' }}>
            ...
            {!loadingRecords && error && <div style={{ padding: '16px 20px', color: '#dc2626', fontWeight: 700 }}>⚠️ {error}</div>}
                  ...
                  {records.map(r => {
                    ...
                    return (
                      <tr key={r.id}
                        ...
                        <td style={{ ...tdSt, fontWeight: 700, color: '#1a1209' }}>{r.student ? `${r.student.firstName} ${r.student.lastName}` : '—'}</td>
