...
export default function SectionTeacherPlaceholder({ title, icon, description, onToast }: Props) {
  return (
    <div style={{ padding: '28px 32px', height: '100%', overflowY: 'auto' }}>
      ...
      <div style={{ background: 'white', borderRadius: 16, border: '1.5px solid #e8e0d4', padding: 52, textAlign: 'center', maxWidth: 580 }}>
        <div style={{ fontSize: 56, marginBottom: 20 }}>{icon}</div>
        <div style={{ fontFamily: 'var(--font-spectral),Spectral,serif', fontSize: 24, fontWeight: 700, color: '#1a1209', marginBottom: 12 }}>
          {title}
        </div>
        <div style={{ fontSize: 17, color: '#a89478', fontWeight: 500, marginBottom: 28, lineHeight: 1.7 }}>
