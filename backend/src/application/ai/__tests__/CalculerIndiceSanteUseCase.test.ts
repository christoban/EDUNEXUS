...
import { CalculerIndiceSanteUseCase } from '../CalculerIndiceSanteUseCase';
import { InMemorySanteEleveRepository } from './helpers/InMemorySanteEleveRepository';
import { FakeIAService } from './helpers/FakeIAService';
