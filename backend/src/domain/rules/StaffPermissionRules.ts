...
export const PERMISSIONS_PAR_TITRE: Record<string, StaffPermissionType[]> = {
  ...
  'Censeur': [
    ...
    'SUPERVISE_TEACHERS', 'MANAGE_ATTENDANCE', 'GENERATE_REPORTS',
  ...
  'Chef des Travaux': [
    'MANAGE_ATELIERS', 'MANAGE_PRACTICAL_GRADES',
    'MANAGE_INTERNSHIPS', 'GENERATE_REPORTS',
  ],
