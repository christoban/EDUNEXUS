...
router.get("/invite/:token", getSchoolOnboardingInvite);
...
router.post("/requests/:requestId/approve", protectMaster, authorizeMaster(["super_admin", "platform_admin"]), masterMfaLimiter, requireMasterSensitiveAuth, approveSchoolOnboardingRequest);
router.post("/requests/:requestId/reject", protectMaster, authorizeMaster(["super_admin", "platform_admin"]), masterMfaLimiter, requireMasterSensitiveAuth, rejectSchoolOnboardingRequest);
