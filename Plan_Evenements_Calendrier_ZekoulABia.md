...
- **Job Inngest quotidien** (`checkAcademicEvents`, cron 6h) : active les événements Type 1 arrivés à échéance, envoie les rappels à 3 jours ouvrés scolaires de la clôture (une seule fois), prolonge automatiquement les fenêtres Type 3 qui tombent sur un jour de fermeture, clôture les événements dont la date de fin est dépassée.
