...
| **schoolSettings** (4 UC) | Paramètres établissement (locale, notifications, etc.) + ré-application template | `app/schoolSettings`, `infra/http/controllers/SchoolSettingsController` | `ObtenirParametresEcoleUseCase`, `MettreAJourParametresEcoleUseCase`, `ProposerReapplicationTemplateUseCase`, `AppliquerReapplicationTemplateUseCase` | `SchoolSettingsRepository`, `SchoolTemplateVersionRepository` |
